...
<LN ID="%IW.#module_path#.Temperature01" Type="INT">
<Prod Device="#module_path#" DPName="Temperature01" Kind="io"/>
</LN>
<LN ID="%IW.#module_path#.Temperature02" Type="INT">
<Prod Device="#module_path#" DPName="Temperature02" Kind="io"/>
</LN>
